...
function DashboardPage() {
  ...
  const fetchPICList = async () => {
    try {
      const response = await fetch("http://localhost:5000/api/pic");
      if (response.ok) {
  ...
  useEffect(() => {
    ...
    filtered.sort((a, b) => {
      ...
      if (sortBy === "tanggal") {
        ...
        aValue = parseFloat(a.total_harga || 0);
        bValue = parseFloat(b.total_harga || 0);
      }
    ...
    try {
      ...
      const url =
        modalMode === "add"
          ...
          : `http://localhost:5000/api/proposals/${currentProposal.id_proposal}`;
          ...
          <div className="modal-overlay" onClick={() => setShowModal(false)}>
            ...
            >
              ...
              <form
                ...
                className="modal-form enhanced-form"
              >
                {/* Basic Information */}
