...
// Global styles - pastikan file ini ada
const globalStyles = `
  * {
    margin: 0;
    padding: 0;
...
function ProtectedRoute({ children, isAuthenticated }) {
  ...
  // Jika tidak terauthentikasi, redirect ke login
  if (!isAuthenticated) {
    return <Navigate to="/login" state={{ from: location }} replace />;
  }

  // Jika terauthentikasi, render children
  return children;
}
...
// ========================================
// src/components/Sidebar.jsx (SAFE VERSION - Tanpa useNavigate error)
// ========================================
